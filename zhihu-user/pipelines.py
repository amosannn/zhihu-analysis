...
class ZhihuPipeline(object):
    def process_item(self, item, spider):
        ...
        param = (item['user_name'],item['sex'],item['user_sign'],item['user_avatar'],item['user_url'],item['locations'],item['voteup_count'],item['thanked_count'],item['follower_count'],item['following_count'],item['following_topic_count'],item['following_question_count'],item['following_favlists_count'],item['following_columns_count'],item['answer_count'],item['articles_count'],item['question_count'],item['commercial_question_count'],item['favorite_count'],item['is_bind_sina'],item['is_following'],item['is_followed'],item['mutual_followees_count'],item['vote_to_count'],item['vote_from_count'],item['thank_to_count'],item['thank_from_count'],item['description'])
        try:
